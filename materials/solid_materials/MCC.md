...
<picture><source srcset="../../.gitbook/assets/MCC_Yield-inverted.png" media="(prefers-color-scheme: dark)"><img src="../../.gitbook/assets/MCC_Yield.png" alt="Modified Cam Clay yield surfaces cut off by failure (critical state) line "></picture>
...
<picture><source srcset="../../.gitbook/assets/sscc3_NEW4-inverted.png" media="(prefers-color-scheme: dark)"><img src="../../.gitbook/assets/sscc3_NEW4.png" alt="Normal compression line (NCL) and unloading–reloading line (URL) in  space (left) and idealized oedometric response in  space."></picture>
